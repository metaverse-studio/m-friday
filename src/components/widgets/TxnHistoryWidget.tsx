    ...
    <div className="card-glass p-5 animate-[riseIn_0.3s_ease-out]">
      ...
      <div className="mt-3.5 border-t border-white/12">
        {transactions.map((txn) => (
          ...
          >
            <span className="w-[34px] shrink-0 font-bold text-caption text-white/40">
              {txn.time}
            </span>
            <span className="flex-1 font-medium text-caption text-white/85">
              {txn.description}
              <span className="block font-normal text-caption text-white/35 mt-0.5">
                {txn.account}
              </span>
            </span>
            <span
              className={`shrink-0 font-bold text-caption ${
