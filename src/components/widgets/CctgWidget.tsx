  ...
  return (
    <div className="card-glass p-5 animate-[riseIn_0.3s_ease-out]">
      ...
      <div className="mt-4 border-t border-white/12">
        <div className="flex justify-between py-2 border-b border-white/10 font-medium text-caption text-white/60">
      ...
      <div className="mt-3.5 bg-signal/10 border border-signal/25 rounded-[8px] p-3.5">
        <p className="font-bold text-caption tracking-[0.14em] text-white/50 m-0 uppercase">
          LỢI TỨC DỰ KIẾN
        </p>
