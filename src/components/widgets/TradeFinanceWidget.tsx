    ...
    <div className="card-glass p-5 animate-[riseIn_0.3s_ease-out]">
      ...
      <div className="mt-4">
        <div className="flex justify-between items-baseline">
          <span className="font-medium text-[12px] leading-none text-white/70">
            THƯ TÍN DỤNG L/C
          </span>
      ...
      <div className="mt-2.5 border-t border-white/12">
        <div className="py-3 border-b border-white/12">
          <p className="font-medium text-[13px] leading-[1.35] text-white/85 m-0">
            L/C nhập khẩu {pendingLc.partner}
          </p>
          <p className="font-normal text-[11px] leading-[1.4] text-white/40 mt-1 m-0">
