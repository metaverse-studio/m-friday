...
export function SessionSummaryWidget() {
  ...
  return (
    <div className="card-glass p-5 animate-[riseIn_0.3s_ease-out]">
      ...
      <p className="mt-3 font-medium text-caption text-white/60 m-0">
      ...
      {covered.length > 0 ? (
        <div className="mt-3.5 border-t border-white/12">
          {covered.map((id) => (
            <div
              key={id}
              className="flex gap-2.5 py-2.5 border-b border-white/10 font-medium text-caption text-white/85"
            >
        ...
        <p className="mt-3.5 font-medium text-caption text-white/40 m-0">
