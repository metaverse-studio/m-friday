  ...
  return (
    <div className="card-glass p-5 animate-[riseIn_0.3s_ease-out]">
      <div className="flex items-start justify-between">
        ...
        <span className="font-bold text-[11px] leading-none text-msb-orange uppercase">
      ...
      <div className="grid grid-cols-2 mt-4 border border-white/12 rounded-[8px] overflow-hidden">
        <div className="p-3 border-r border-white/12 bg-white/[0.02]">
          ...
          <p className="mt-2 font-bold text-[18px] md:text-[19px] leading-none text-msb-orange m-0">
            {formatTrieuRaw(fxFloatRisk())} tr
          </p>
          <p className="mt-1 font-normal text-[10.5px] leading-[1.3] text-white/35 m-0">
            chi phí phát sinh
          </p>
        </div>
        ...
        <div className="p-3 bg-signal/10">
          ...
          <p className="mt-2 font-bold text-[18px] md:text-[19px] leading-none text-signal m-0">
      ...
      <p className="mt-3.5 font-bold text-[13px] leading-[1.3] text-msb-gold m-0">
