...
export function ApprovalWidget({ intent }: { intent?: IntentId } = {}) {
    ...
    return (
      <div className="rounded-[12px] bg-[#1A1417]/95 border border-msb-orange/50 p-5 shadow-[0_8px_32px_rgba(244,96,12,0.15)] animate-[riseIn_0.3s_ease-out]">
        <div className="flex items-center gap-2">
          <div className="w-3.5 h-3.5 rounded-full bg-msb-orange flex items-center justify-center text-white text-caption font-bold">
            ✕
          </div>
          <p className="font-bold text-caption tracking-[0.16em] uppercase text-msb-orange m-0">
        ...
        <div className="mt-4 border-t border-white/12 pt-3.5">
          <p className="font-bold text-caption tracking-[0.16em] text-msb-gold uppercase m-0">
            GHI CHÚ ĐỌC BẰNG GIỌNG NÓI
          </p>
          <p className="mt-2.5 bg-white/5 border-l-[3px] border-msb-gold rounded-r-[6px] p-3 px-3.5 font-medium text-small text-white/85 m-0">
            “thiếu hóa đơn đầu vào”
          </p>
          <p className="mt-2.5 font-normal text-caption text-white/40 m-0">
  ...
  return (
    <div className="card-glass border-signal/50 p-5 shadow-[0_8px_32px_rgba(18,183,106,0.15)] animate-[riseIn_0.3s_ease-out]">
      <div className="flex items-center gap-2">
        <div className="w-3.5 h-3.5 rounded-full bg-signal flex items-center justify-center text-white text-caption font-bold">
          ✓
        </div>
        <p className="font-bold text-caption tracking-[0.16em] uppercase text-signal m-0">
          Đã ký duyệt điện tử
        </p>
      </div>
      ...
      <p className="mt-3 font-bold text-h3 tracking-[-0.02em] text-white m-0">
        ...
        <span className="font-bold text-small text-white/50"> TỶ VNĐ</span>
      </p>
      ...
      <div className="mt-4 border-t border-white/12">
        <div className="flex justify-between py-2 border-b border-white/12 font-medium text-caption text-white/60">
          <span>Xác thực</span>
