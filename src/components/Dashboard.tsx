        ...
        <header className="flex-none pt-4 sm:pt-6 md:pt-5 px-4 sm:px-5 md:px-7 bg-[#0D2745]/70 backdrop-blur-[16px]">
          ...
          <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-white/12">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-[14px] md:text-[15px] leading-none text-white tracking-[0.02em]">
                MSB
              </span>
              <span className="font-bold text-[9px] md:text-[10px] leading-none tracking-[0.18em] text-msb-gold">
                BUSINESS
              </span>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              <div className="text-right">
                <p className="font-semibold text-[11px] md:text-[12px] leading-tight text-white m-0">MR STARK</p>
                <p className="font-normal text-[9px] leading-none tracking-[0.08em] text-white/40 mt-0.5 m-0">
                  CFO · CHECKER 1
                </p>
              </div>
              <div className="w-[28px] h-[28px] rounded-full bg-msb-gold/20 border border-msb-gold/60 flex items-center justify-center font-bold text-[11px] md:text-[12px] leading-none text-msb-gold">
                S
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-[1fr_auto] items-end gap-2.5 py-2.5 sm:py-3 border-b border-white/12">
            <div>
              <p className="font-semibold text-[8.5px] sm:text-[9px] leading-none tracking-[0.16em] text-white/40 m-0 uppercase">
                SỐ DƯ KHẢ DỤNG · VND
              </p>
        ...
        <div className="flex lg:hidden flex-col flex-1 overflow-hidden min-h-0">
          ...
          <section className="flex-none px-4 sm:px-5 py-2.5 sm:py-3 border-b border-white/12 bg-card/85 backdrop-blur-md">
            <div className="flex items-center gap-2 mb-1 sm:mb-1.5">
              <div className="w-4 h-4 rounded-full bg-msb-gold/20 border border-msb-gold/60 flex items-center justify-center font-bold text-[8px] leading-none text-msb-gold">
                F
              </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-5 py-3 sm:py-4 no-scrollbar min-h-0">
            {!activeIntent || activeIntent === 'GREETING' ? (
              <div className="animate-[riseIn_0.3s_ease-out]">
                <p className="font-semibold text-[9px] leading-none tracking-[0.18em] text-white/35 m-0 uppercase">
                  GỢI Ý MỞ PHIÊN
                </p>
                <div className="mt-3 flex flex-col gap-2">
                  <button
                    ...
                    className="w-full flex justify-between items-center gap-2.5 p-3 rounded-[8px] bg-card/60 hover:bg-card/90 border border-white/10 hover:border-msb-gold/40 text-[13px] text-white/85 hover:text-white text-left cursor-pointer transition-all"
                  >
                    <span className="font-medium">“Tuần này thu chi thế nào?”</span>
                    <span className="font-normal text-[11px] text-white/40 shrink-0">Dòng tiền →</span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="font-normal text-[11px] text-white/40 shrink-0">Phê duyệt →</span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="font-normal text-[11px] text-white/40 shrink-0">Rủi ro →</span>
                  </button>
                </div>
              </div>
            ) : (
          ...
          <footer className="flex-none border-t border-white/12 bg-[#0D2745]/90 backdrop-blur-md">
            ...
            <div className="flex items-stretch gap-2.5 sm:gap-3 px-4 sm:px-5 pt-2 sm:pt-3 pb-3 sm:pb-4">
              <button
                ...
                className="flex-1 flex items-center justify-between gap-2.5 p-3 sm:p-3.5 px-4 sm:px-5 btn-primary-msb shadow-[0_4px_16px_rgba(244,96,12,0.35)] cursor-pointer text-left font-semibold text-[12px] sm:text-[12.5px] leading-none tracking-[0.08em] uppercase transition-all"
              >
              ...
              <div className="w-[74px] flex flex-col justify-center items-end border-l border-white/12 pl-2.5 sm:pl-3">
                <p className="font-bold text-[13px] sm:text-[14px] leading-none text-signal m-0">
                  {lastLatencyMs !== null ? `${lastLatencyMs}ms` : '—'}
                </p>
                <p className="font-normal text-[7.5px] sm:text-[8px] leading-none tracking-[0.08em] text-white/35 mt-1 m-0 uppercase">
                  TO-FIRST-AUDIO
                </p>
              </div>
            </div>
              ...
              <div className="p-5">
                ...
                <div className="mt-3 flex flex-col gap-2">
                  <button
                    type="button"
                    onClick={() => void runIntent('CASH_FLOW')}
                    className="w-full flex justify-between items-center gap-2.5 p-3 rounded-[8px] bg-card/60 hover:bg-card/90 border border-white/10 hover:border-msb-gold/40 text-[13px] text-white/80 hover:text-white text-left cursor-pointer transition-all"
                  >
                    <span className="font-medium">“Tuần này thu chi thế nào?”</span>
                    <span className="font-normal text-[11px] text-white/40 shrink-0">Dòng tiền →</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="font-normal text-[11px] text-white/40 shrink-0">Tư vấn CCTG →</span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="font-normal text-[11px] text-white/40 shrink-0">Thương mại →</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-white/12 bg-[#0D2745]/90 backdrop-blur-md pb-5 pt-1">
              ...
              <div className="flex items-stretch gap-3 px-5">
                <button
                  type="button"
                  onClick={handleTalkClick}
                  className="flex-1 flex items-center justify-between gap-2.5 p-3.5 px-5 btn-primary-msb shadow-[0_4px_16px_rgba(244,96,12,0.35)] cursor-pointer text-left font-semibold text-[12.5px] leading-none tracking-[0.08em] uppercase transition-all"
                >
                  <span>{talkButtonText}</span>
                  <span className="flex items-end gap-0.5 h-3.5">
                    <i className="w-[2.5px] h-[40%] bg-white/85 rounded-full" />
                ...
                <div className="w-[80px] flex flex-col justify-center items-end border-l border-white/12 pl-3">
                  <p className="font-bold text-[14px] leading-none text-signal m-0">
                    {lastLatencyMs !== null ? `${lastLatencyMs}ms` : '—'}
                  </p>
                  <p className="font-normal text-[8px] leading-none tracking-[0.08em] text-white/35 mt-1 m-0 uppercase">
                    TO-FIRST-AUDIO
                  </p>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-col overflow-y-auto p-6 lg:p-8 bg-[#090E17]/60 backdrop-blur-md no-scrollbar">
            {!activeIntent || activeIntent === 'GREETING' ? (
              <div className="h-full flex flex-col justify-center items-center text-center p-8 card-glass">
                <div className="w-12 h-12 rounded-full bg-msb-gold/15 border border-msb-gold/60 flex items-center justify-center font-bold text-[18px] text-msb-gold mb-4">
                  F
                </div>
                <h3 className="font-bold text-[22px] text-white m-0 tracking-tight">
                  Chào mừng Mr Stark đến với MSB Business
                </h3>
                <p className="mt-3 max-w-lg font-normal text-[13.5px] leading-[1.6] text-white/70">
                ...
                <div className="grid grid-cols-2 gap-3 mt-6 w-full max-w-md">
                  <button
                    type="button"
                    onClick={() => void runIntent('CASH_FLOW')}
                    className="p-3 bg-card/80 hover:bg-card border border-white/12 hover:border-msb-gold/50 rounded-[8px] text-left font-medium text-[12.5px] text-white/90 cursor-pointer transition-all"
                  >
                    Dòng tiền 7 ngày →
                  </button>
                  <button
